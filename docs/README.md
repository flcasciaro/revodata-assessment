...
Assessment project for RevoData
...
- **[Pipeline Design](pipeline.md)** - What the property-revenue pipeline does and why: scoping, cleaning, the postal code backfill, and the revenue assumptions
